...
<div class="w-full max-w-3xl mx-auto mb-8">
    <div class="min-w-0 p-6 bg-white rounded-xl shadow-xs dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        ...
        <form id="automationCreateForm" action="index.php?page=tudong-store" method="POST" class="space-y-6">
            <input type="hidden" name="dieuKien" id="dieuKienPayload">
            <input type="hidden" name="hanhDong" id="hanhDongPayload">
            <input type="hidden" name="moTa" id="moTaPayload">
            ...
            <label class="block text-sm">
                ...
                <input type="text" id="scriptName" name="tenKichBan" required
                ...
                <div class="p-4 bg-blue-50/50 rounded-xl border border-blue-100 dark:bg-gray-700/50 dark:border-gray-600">
                    ...
                    <div class="grid gap-4 md:grid-cols-12">
                        <div class="md:col-span-5">
                            ...
                            <select id="sensorSelect" name="sensorType" onchange="changeUnit()" class="block w-full text-sm dark:bg-gray-800 dark:text-gray-300 form-select h-11 border rounded-lg px-3">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <select id="sensorOperator" name="sensorOperator" class="block w-full text-sm dark:bg-gray-800 dark:text-gray-300 form-select h-11 border rounded-lg px-3">
                        ...
                        <div class="md:col-span-4">
                            ...
                            <div class="relative">
                                <input type="number" step="0.1" id="sensorThreshold" name="sensorThreshold" class="block w-full pr-14 text-sm dark:bg-gray-800 dark:text-gray-300 form-input h-11 border rounded-lg px-3" placeholder="0.0">
                    ...
                    <div class="space-y-4">
                        <div class="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <input type="time" id="gioBatDau" name="gioBatDau" class="block w-full text-sm dark:bg-gray-800 dark:text-gray-300 form-input h-11 border rounded-lg px-3" value="18:00">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">Giờ kết thúc</label>
                                <input type="time" id="gioKetThuc" name="gioKetThuc" class="block w-full text-sm dark:bg-gray-800 dark:text-gray-300 form-input h-11 border rounded-lg px-3" value="06:00">
                            </div>
                        </div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <?php foreach ($days as $index => $day): ?>
                                    <label class="cursor-pointer">
                                        <input type="checkbox" name="days[]" value="<?= $day ?>" class="sr-only peer" <?= $index < 5 ? 'checked' : '' ?>>
                                        <div class="w-10 h-10 flex items-center justify-center text-xs font-bold border-2 rounded-xl peer-checked:bg-blue-600 peer-checked:text-white peer-checked:border-blue-600 dark:border-gray-600 transition-all"><?= $day ?></div>
                                    </label>
                                <?php endforeach; ?>
                            </div>
                        </div>
            ...
            <div class="p-4 bg-green-50/50 rounded-xl border border-green-100 dark:bg-gray-700/50 dark:border-gray-600">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <select id="actionDevice" name="actionDevice" class="block w-full text-sm dark:bg-gray-800 dark:text-gray-300 form-select h-11 border rounded-lg px-3">
                    ...
                    <div>
                        ...
                        <select id="actionState" name="actionState" class="block w-full text-sm dark:bg-gray-800 dark:text-blue-500 form-select h-11 border rounded-lg px-3 font-bold">
...
<script>
    ...
    function buildConditionPayload() {
        ...
        const unit = document.getElementById('unitText').innerText;
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('automationCreateForm').addEventListener('submit', function(e) {
